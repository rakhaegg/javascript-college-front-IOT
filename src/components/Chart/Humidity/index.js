...
class DataHumidity extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            result: [],
    ...
    */
    ...
    tick() {
        fetch('http://localhost:3001/api/humidity')
            ...
            .then(data => {
                ...
                this.props.handleHumidity(this.state.realtime)
            })
                ...
                <div className="row" style={{ position: 'relative', top: '400px' }}>
                    ...
                    <div className="col">
                        <div>
                            ...
                            <div class="alert alert-info">
                                <strong>RealTime Humidity : </strong> {this.state.realtime}
                            </div>
                        </div>
                        <div>
                            <div class="alert alert-info">
